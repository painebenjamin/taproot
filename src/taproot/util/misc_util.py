...
def sliding_3d_window_count(
    ...
    :param tile_stride: The stride of the tile.
    """
    temporal_windows = sliding_1d_window_count(frames, frame_window_size, frame_window_stride)
...
def sliding_3d_windows(
    ...
    :param tile_stride: The stride of the tile.
    """
    temporal_windows = sliding_1d_windows(frames, frame_window_size, frame_window_stride)
